...
const CustomReactTable = <D extends object>({ table, columns, pageParams, onChangePage, onChangeRowsPerPage, handleSort, data }: CustomReactTableProps<D>) => {
    ...
    return (
        <TableContainer style={{ overflow: "hidden" }}>
            <Table stickyHeader style={{ overflow: "hidden" }} {...getTableProps()}>
            ...
            <CustomTableFooter pageParams={pageParams} onChangePage={onChangePage} onChangeRowsPerPage={onChangeRowsPerPage} loading={loading} />
        </TableContainer>
    );
};
